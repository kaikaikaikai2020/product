...
def indexer(Data, expected_cost, lot, investment,buy_index):
    # Charting portfolio evolution
    #indexer = Data[:, 8:10]
    indexer = Data[:, buy_index:buy_index+2]
...
def performance(indexer, Data, name,expected_cost, lot, investment):
    # Profitability index
