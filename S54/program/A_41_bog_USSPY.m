...
for index_id = 1:T
    ...
    index=fetchmysql('select tradeDate,closePrice from polygon.usastock_day where ticker = "SPY" and tradeDate>="2012-01-01" order by tradeDate',2);
