...
%{
x = readtable('data20200920.xlsx','Sheet','Sheet2');
[m,n] = size(x);
T = n/2;
data = [];
for i = 1:T
    ...
    data.(strrep(var,'Curncy','')) = sub_x;
end

x = readtable('data20200920.xlsx','Sheet','Sheet1');
[m,n] = size(x);
T = n;
for i = 2:T
    sub_ind = [1,i];
    ...
    sub_x(:,1) = cellfun(@char,sub_x(:,1),'UniformOutput',false);
    sub_x(:,1)=cellstr(datestr(datenum(sub_x(:,1)),'yyyy-mm-dd'));
    %sub_x(:,2) = cellfun(@str2double,sub_x(:,2),'UniformOutput',false);
    data.(strrep(var,'Curncy','')) = sub_x;
end
save tempdata20200920
%}
load tempdata20200920
%usdtwd usdcnh
symbol_pool = {'NTN_1M','CNH_1M';'CNH_1M','CNH_2M';...
    'CNH_1M','CNH_3M';'CNH_1M','CNH_6M';...
    'CNH_1M','CNH_12M';'CNH_6M','CNH_12M';...
    'NTN_1M','IRN_1M';'IRN_1M','IRN_2M';...
    'IRN_1M','IRN_3M';'IRN_1M','IRN_6M';...
    'IRN_1M','IRN_12M';'IRN_6M','IRN_12M'};
...
writetable(X,'A1_A38_KF_beta_ntn_20200920.csv')