# -*- coding: utf-8 -*-
"""
Created on Fri Apr 30 16:35:09 2021
...
df = DataAPI.MktEqudAdjGet(ticker="600210", beginDate=u"20010101", endDate=u"20210101", pandas="1")
# %%
#df = pd.read_csv('./data/hs_300.csv', index_col=0)
#df = pd.read_csv('./data/hs_500.csv', index_col=0)
s = df['closePrice'].copy()
...
sign_long = s_df.apply(lambda x: 1 if x['dir'] == 1 and x['closePrice'] > x['max_last'] else 0, axis=1)
